...
const shortcuts = [
  { to: "/admin/fornecedores", label: "Fornecedores", desc: "Cadastro de parceiros e ateliês." },
  { to: "/admin/fornecedores/pedidos", label: "Pedidos de compra", desc: "Ordens em curso e recebidas." },
  { to: "/admin/categorias", label: "Categorias", desc: "Estrutura de coleções e famílias." },
  { to: "/admin/produtos", label: "Produtos", desc: "Ficha, preço e disponibilidade." },
  { to: "/admin/estoque", label: "Estoque", desc: "Saldos por depósito e movimentações." },
] as const;
